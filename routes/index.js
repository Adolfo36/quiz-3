...
router.param('commentId',	commentController.load);  // autoload :comentId
...
router.get('/quizes/b/', 						quizController.buscador);
...
router.get('/quizes/:quizId(\\d+)/comments/:comemntId(\\d+)/publish',
